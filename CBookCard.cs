...
namespace _25_2
{
    internal class CBookCard
    {
        ...
        {
            return $"Автор: {Author}\tЗаглавие: {Title}\tИздательство: {PublicationHouse}\tГод издания: {PublicationYear}\tЧисло страниц: " +
                $"{Pages}\tТираж: {Printing}\tРейтинг: {Rating}\tКомментарий: {Commentary}";
        }
    }
}
